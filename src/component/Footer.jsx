...
export default function Footer() {
  return (
    <>
      ...
      <div className="bg-[#F94F46] rounded-[24px] px-6 md:px-20 py-10 text-center text-white mb-10 h-[410px] flex flex-col items-center gap-6">
        <h2 className="text-4xl font-medium mb-2" style={{ fontFamily: 'Inter' }}>
            What You Need Is Strategy, Positioning, And Precision.
        </h2>
        <p className="text-lg leading-[40px] text-[#FFFFFF] font-light" style={{ fontFamily: 'Inter',fontWeight: 400 }}>
            At ATS RESUME, Every Resume Is Crafted By A Seasoned HR Professional Who Understands
        </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-2 md:px-0 -mt-50 mx-10">
        
          <div className="bg-white shadow-lg border-white rounded-2xl p-6 text-center flex flex-col items-center -mt-10">
          ...
          <div className="bg-white shadow-lg rounded-2xl p-6 text-center flex flex-col items-center -mt-10">
